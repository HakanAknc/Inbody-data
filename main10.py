import os      # TODO bu dosya izleme, çevirme ve çalışan çalışmayan dosyaları ayrıma işlemi yapıyor.
...
def process_and_save_file(input_file_path, success_folder, error_folder):
    ...
    output_file_path_success = os.path.join(success_folder, filename)
    output_file_path_error = os.path.join(error_folder, filename)
